...
use crate::app::interactive_split::split_state::SplitState;

use super::splitter_orientation::{SplitterOrientation, SplitterResponse};
...
impl Splitter {
    ...
    pub fn show_dyn<'c, R>(
        ...
        SplitState { ratio }.store(ui.ctx(), ui.id());
