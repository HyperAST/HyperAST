...
use hyper_ast::{
    ...
    types::{AnyType, HyperType, Lang, TypeTrait, TypeStore, NodeId, TypedNodeId, LangRef, LangWrapper},
};
...
mod legion_impls {
    ...
    impl<'a> TypeStore<HashedNodeRef<'a, NodeIdentifier>> for TStore {
        ...
        fn resolve_type(&self, n: &HashedNodeRef<'a, NodeIdentifier>) -> Self::Ty {
            From::<&'static (dyn HyperType)>::from(LangRef::<Type>::make(&Cpp,*n.get_component::<Type>().unwrap() as u16))
        }
