...
use crate::code_editor::generic_text_buffer::AAA;
...
mod aaa {
    ...
    // impl From<TextEditState> for egui::text_edit::TextEditState {
    //     fn from(value: TextEditState) -> Self {
    //         Self {
    //             cursor_range: value.cursor_range,
    //             ccursor_range: value.ccursor_range,
    //             undoer: value.undoer,
    //             has_ime: value.has_ime,
    //             singleline_offset: value.singleline_offset,
    //         }
    //     }
    // }
