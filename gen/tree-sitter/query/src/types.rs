    ...
    pub fn from_str(s: &str) -> Option<Type> {
        Some(
            match s {
                ...
                "_definition" => Type::TS4,
                "_group_expression" => Type::TS5,
                "_named_node_expression" => Type::TS6,
                "_string" => Type::TS7,
                "quantifier" => Type::Quantifier,
                "_immediate_identifier" => Type::TS8,
                "_node_identifier" => Type::TS9,
