...
impl<'aaa, 'hast, 'g, 'q, 'm, HAST, Acc> tree_gen::More
    ...
    >
where
    // HAST::TM: hyperast::types::MarkedT,
    HAST: HyperAST + Clone,
    ...
    for<'acc> &'acc Acc: tree_gen::WithLabel<L = &'acc str>,
{
    ...
    fn match_precomp_queries<
        HAST2: for<'t> hyperast::types::AstLending<
                't,
                Label = <Self::T as hyperast::types::MarkedT>::Label,
                Idx = <Self::T as hyperast::types::MarkedT>::ChildIdx,
                // RT = hyperast::types::LendN<
                //     't,
                //     Self::T,
                //     <Self::T as hyperast::types::Stored>::TreeId,
                // >,
            > + hyperast::types::HyperAST<
...
impl<'aaa, 'g, 'q, 'm, 'hast, HAST, Acc> tree_gen::Prepro<<HAST::TS as types::ETypeStore>::Ty2>
    ...
    >
where
    HAST::TM: hyperast::types::MarkedT<ChildIdx = HAST::Idx>,
    HAST: HyperAST + Clone,
    HAST::IdN: Copy + Hash + Debug,
    HAST::Idx: Hash,
    for<'t> <HAST as hyperast::types::AstLending<'t>>::RT:
    ...
    for<'acc> &'acc Acc: tree_gen::WithLabel<L = &'acc str>,
{
    ...
    fn compute_tsg2<HAST2: HyperAST + std::clone::Clone>(
        &self,
        stores: HAST2,
        acc: &Acc,
        label: Option<&str>,
