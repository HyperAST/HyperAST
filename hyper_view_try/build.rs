// inspired by https://github.com/rerun-io/rerun/blob/main/crates/re_web_server/build.rs
...
fn build_web() {
    ...
    let crate_name = "hyper_view";
    let build_dir = format!("{repository_root_dir}/dist");//web_viewer
